...
/////Get position from encoders rather than gyro
    ...
    public void setDesiredState(SwerveModuleState state) {
        ...
        double driveSpeed = MathUtil.clamp(state.speedMetersPerSecond  / Constants.DriveConstants.kTeleDriveMaxSpeedMetersPerSecond/* / 360*/, -0.75 ,0.75); // Halved for practice for David 😈
